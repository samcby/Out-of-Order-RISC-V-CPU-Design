...
module tb_top_rv32i_smoke;
    ...
    initial begin
        ...
        dut.u_execution.u_lsu.mem[0] = 32'h0154ff55;
        ...
        store_word = dut.u_execution.u_lsu.mem[1];

        $display("[SUMMARY] a0_preg=%0d a0=%0d (0x%08h) a1_preg=%0d a1=%0d (0x%08h) store_word=0x%08h rob_empty=%0b",
        ...
        check_ok(store_word == 32'h01540055, "RV32I smoke sb/sh store word matches expected 0x01540055");
