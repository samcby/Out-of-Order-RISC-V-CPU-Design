module top (
    ...
    assign interrupt_mcause   = external_irq_enabled ? MCAUSE_MEI :
                                ...
                                MCAUSE_MTI;
    assign interrupt_mepc     = pipe_fd_s.valid ? pipe_fd_s.data.pc :
                                pipe_fd.valid   ? pipe_fd.data.pc   :
                                pipe_dr_s.valid ? pipe_dr_s.data.datapath.pc :
                                pipe_dr.valid   ? pipe_dr.data.datapath.pc   :
                                32'b0;
